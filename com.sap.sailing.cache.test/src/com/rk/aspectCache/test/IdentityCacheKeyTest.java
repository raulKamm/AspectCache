...
public class IdentityCacheKeyTest {
	...
	public void test() {
		...
		args5[1] = r;
		args5[2] = str1;
		CacheKey key5 = new IdentityCacheKey(signature3, args5);
		int j = 5;
		...
		args6[1] = s;
		args6[2] = str2;
		CacheKey key5bis = new IdentityCacheKey(signature3, args6);
		assertFalse(key5.equals(key5bis));
		
		// same method, identical arguments (mixed parameters)
		CacheKey key5ter = new IdentityCacheKey(signature3, args5);	
