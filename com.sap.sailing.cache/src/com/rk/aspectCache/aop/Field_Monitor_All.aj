...
public aspect Field_Monitor_All extends Abstract_Field_Monitor{
	...
	pointcut dataFieldGet(Object obj): get(!@IgnoreField !final (!(Object+[]) && !(int[])) && !(byte[]) && !(short[]) && !(long[]) && !(float[]) && !(double[]) && !(boolean[]) && !(char[]) *) && cflow(cachedMethod()) && target(obj) && !within(com.sap.sailing.cache.aop.*) && !within(com.sap.sailing.cache.common.*) && !within(com.sap.sailing.cache.impl.*);
	// picks all set of non-final, non-static, non-array type fields
	pointcut dataFieldSet(Object obj): set(!@IgnoreField !final (!(Object+[]) && !(int[])) && !(byte[]) && !(short[]) && !(long[]) && !(float[]) && !(double[]) && !(boolean[]) && !(char[]) *) && target(obj) && !within(com.sap.sailing.cache.aop.*) && !within(com.sap.sailing.cache.common.*) && !within(com.sap.sailing.cache.impl.*);
	// picks all references to static, non-final, non-array type fields happening in the control flow of cachedMethod()
	pointcut dataFieldGetStatic(): get(!@IgnoreField static !final (!(Object+[]) && !(int[])) && !(byte[]) && !(short[]) && !(long[]) && !(float[]) && !(double[]) && !(boolean[]) && !(char[]) *) && cflow(cachedMethod()) && !within(com.sap.sailing.cache.aop.*) && !within(com.sap.sailing.cache.common.*) && !within(com.sap.sailing.cache.impl.*);
	// picks all set of static, non-final, non-array type fields
	pointcut dataFieldSetStatic(): set(!@IgnoreField static !final (!(Object+[]) && !(int[])) && !(byte[]) && !(short[]) && !(long[]) && !(float[]) && !(double[]) && !(boolean[]) && !(char[]) *) && !within(com.sap.sailing.cache.aop.*) && !within(com.sap.sailing.cache.common.*) && !within(com.sap.sailing.cache.impl.*);
